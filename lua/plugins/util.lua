return {
    ...
    { -- NOTE: move down or up quickly (smooth accelerated motion)
        ...
        config = function (_, opts)
            ...
            map({ "n", "v", "x" }, custom_keymaps.accelerated.quick_up, quick_up_func, { silent = true, desc = "[Move] Up Quickly" })
            map({ "n", "v", "x" }, custom_keymaps.accelerated.quick_down, quick_down_func, { silent = true, desc = "[Move] Down Quickly" })
        end
    },
